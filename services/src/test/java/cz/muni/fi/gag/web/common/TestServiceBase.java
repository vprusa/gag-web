...
public class TestServiceBase extends TestBase {
    ...
    public FingerSensorOffset buildFingerSensorOffset(Sensor fingerPosition) {
    ...
    public FingerSensorOffset buildFingerSensorOffsetWithPersistentRefs(Sensor fingerPosition) {
    ...
    public HandDevice buildHandDevice() {
        ...
        for (Sensor fingerPosition : Sensor.values()) {
