package cz.gag.tests.recognition;
...
import cz.gag.web.services.filters.RecordedDataFilterImpl;
...
import cz.gag.web.services.recognition.comparators.SensorComparator;
...
// http://arquillian.org/guides/getting_started_rinse_and_repeat/#debug_a_managed_server
    ...
    public static WebArchive deployment() {
        ...
        return ShrinkWrap.create(WebArchive.class, clazz.getSimpleName() + ".war")
                .addPackages(true, "cz.gag.web.persistence")
                .addPackages(true, "cz.gag.web.services")
                .addPackages(true, "cz.gag.tests.common")
                .addPackages(true, "cz.gag.tests.filters")
                .addPackages(true, "cz.gag.tests.recognition")
