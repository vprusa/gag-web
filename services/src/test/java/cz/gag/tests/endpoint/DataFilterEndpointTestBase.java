...
import cz.gag.tests.common.TestBase;
...
public abstract class DataFilterEndpointTestBase<EntityExt extends GenericEntity>
        extends AuthenticationTestBase {

    private static Logger log = Logger.getLogger(DataFilterEndpointTestBase.class.getSimpleName());
