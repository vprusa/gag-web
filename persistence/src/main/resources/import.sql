...
INSERT INTO Users (role, thirdPartyId) VALUES (1,'user1:thirdPartyId')
INSERT INTO Users (role, thirdPartyId) VALUES (2,'sqladmin:thirdPartyId')

INSERT INTO gesture (dateCreated, userAlias, user_id) VALUES ('1970-01-01 00:00:01', 'testGesture1',1)

INSERT INTO handDevice (deviceId, user_id) VALUES ('uniqueDeviceId', 1)
